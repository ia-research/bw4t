...
public interface IAServerInterface extends Remote {
    public void registerClient(String agentId, BW4TClientActions client) throws RemoteException;    //public void registerBot(String botName, IAControllerInterface bot) throws RemoteException;
    /*
